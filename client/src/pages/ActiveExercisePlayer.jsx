...
const ActiveExercisePlayer = () => {
  ...
  // Reliable royalty-free placeholder URL
  const audioUrl = 'https://cdn.pixabay.com/download/audio/2022/05/16/audio_db6591201e.mp3?filename=ambient-piano-amp-strings-10711.mp3';
